...
/* harmony export */   "default": () => (/* binding */ ParticleNetwork)
/* harmony export */ });
...
/* harmony import */ var _ParticleOptions_ParticleOptions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _Particle_Particle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _LineHubOptions_LineHubOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
/* harmony import */ var _LineHub_LineHub__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(13);
...
var ParticleNetwork = /*#__PURE__*/function () {
  function ParticleNetwork(parentSelector) {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, ParticleNetwork);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ParticleNetwork, [{
    key: "initCanvas",
    value: function initCanvas(parentSelector) {
      var $parent = document.querySelector(parentSelector);

      if (!$parent) {
        throw new Error("\uC120\uD0DD\uC790 [".concat(parentSelector, "] \uC694\uC18C\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4."));
      }
    ...
    key: "initParticleOptions",
    value: function initParticleOptions() {
      this.particleOptions = new _ParticleOptions_ParticleOptions__WEBPACK_IMPORTED_MODULE_2__["default"]({
        amount: 50,
    ...
    value: function initParticles() {
      var canvas = this.canvas,
          particleOptions = this.particleOptions;
      this.particles = Array.from({
        length: particleOptions.amount
      }, function () {
        return new _Particle_Particle__WEBPACK_IMPORTED_MODULE_3__["default"](canvas, particleOptions);
      });
    }
  }, {
    key: "initLineHubOptions",
    value: function initLineHubOptions() {
      this.lineHubOptions = new _LineHubOptions_LineHubOptions__WEBPACK_IMPORTED_MODULE_4__["default"]();
    }
  }, {
    key: "initLineHub",
    value: function initLineHub() {
      var ctx = this.ctx,
          lineHubOptions = this.lineHubOptions,
          particles = this.particles;
      this.lineHub = new _LineHub_LineHub__WEBPACK_IMPORTED_MODULE_5__["default"]({
        ctx: ctx,
    ...
    value: function loopAnimationFrames() {
      ...
      this.animationFrameId = window.requestAnimationFrame(function () {
        return _this.loopAnimationFrames();
      });
    }
  }, {
    key: "drawScene",
...
var ParticleOptions = /*#__PURE__*/(0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(function ParticleOptions(_ref) {
  var amount = _ref.amount,
      color = _ref.color,
      _ref$defaultRadius = _ref.defaultRadius,
      defaultRadius = _ref$defaultRadius === void 0 ? 5 : _ref$defaultRadius,
      ...
      defaultSpeed = _ref$defaultSpeed === void 0 ? 3 : _ref$defaultSpeed,
      _ref$variantSpeed = _ref.variantSpeed,
      variantSpeed = _ref$variantSpeed === void 0 ? 5 : _ref$variantSpeed;

  (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, ParticleOptions);
...
var Particle = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Particle, [{
    ...
    key: "initColor",
    value: function initColor(_ref) {
      var color = _ref.color;
      this.color = color;
    }
  }, {
    key: "initRadius",
    value: function initRadius(_ref2) {
      var defaultRadius = _ref2.defaultRadius,
          variantRadius = _ref2.variantRadius;
      this.radius = defaultRadius + variantRadius * Math.random();
    }
  }, {
    key: "initSpeed",
    value: function initSpeed(_ref3) {
      var defaultSpeed = _ref3.defaultSpeed,
          variantSpeed = _ref3.variantSpeed;
      this.speed = defaultSpeed + variantSpeed * Math.random();
    }
  }, {
    key: "initDirectionAngle",
    value: function initDirectionAngle() {
      this.directionAngle = Math.PI * 2 * Math.random();
    }
  }, {
    key: "initVector",
    value: function initVector() {
...
var LineHubOptions = /*#__PURE__*/(0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(function LineHubOptions() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$lineRadius = _ref.lineRadius,
      lineRadius = _ref$lineRadius === void 0 ? 200 : _ref$lineRadius,
      _ref$color = _ref.color,
      color = _ref$color === void 0 ? "rgba(0, 181, 255)" : _ref$color;

  (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, LineHubOptions);

  this.lineRadius = lineRadius;

  var _ref2 = color.match(/\d+/g),
...
/* harmony export */ });
/* harmony import */ var _arrayWithHoles_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
/* harmony import */ var _iterableToArrayLimit_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9);
/* harmony import */ var _unsupportedIterableToArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _nonIterableRest_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
...
/* harmony export */ });
/* harmony import */ var _arrayLikeToArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
...
var LineHub = /*#__PURE__*/function () {
  function LineHub(_ref) {
    ...
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, LineHub);
  ...
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(LineHub, [{
    key: "draw",
    value: function draw() {
      var _this = this;

      this.particles.forEach(function (sour) {
        return _this.lineToOthers(sour);
      });
    }
  }, {
    key: "lineToOthers",
    value: function lineToOthers(sour) {
      var _this2 = this;

      this.particles.forEach(function (dest) {
        return _this2.lineToDest(sour, dest);
      });
    }
  }, {
    key: "lineToDest",
    value: function lineToDest(sour, dest) {
      var distance = Math.abs(sour.calcDistance(dest));
      var opacity = this.calcOpacity(distance);
      ...
      if (opacity > 0) {
        ...
        var x2 = dest.x,
            y2 = dest.y;
        ctx.save();
        ctx.strokeStyle = "rgba(".concat(r, ", ").concat(g, ", ").concat(b, ", ").concat(opacity, ")");
        ctx.beginPath();
        ctx.moveTo(x1, y1);
        ctx.lineTo(x2, y2);
        ctx.stroke();
    ...
    key: "calcOpacity",
    value: function calcOpacity(distance) {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_app_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21);
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ParticleNetwork_ParticleNetwork__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _app_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);


window.addEventListener("DOMContentLoaded", function () {
  return new _ParticleNetwork_ParticleNetwork__WEBPACK_IMPORTED_MODULE_0__["default"](".canvasWrapper");
});
})();
