...
/* harmony export */ });
/* harmony import */ var _ParticleOptions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _Particle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _LineHubOptions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _LineHub__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
...
var ParticleNetworkCanvas = /*#__PURE__*/function () {
  ...
  _createClass(ParticleNetworkCanvas, [{
    ...
    value: function initCanvas(selector) {
      ...
      if (!this.canvas || !(this.canvas instanceof HTMLCanvasElement)) throw new Error("".concat(selector, " <canvas />\uB97C \uCC3E\uC9C0 \uBABB\uD558\uC600\uC2B5\uB2C8\uB2E4."));
    ...
    value: function initParticles() {
      var particleOptions = this.particleOptions,
          canvas = this.canvas;
    ...
    value: function initLineHub() {
      this.lineHub = new _LineHub__WEBPACK_IMPORTED_MODULE_3__["default"](this.lineHubOptions, this.particles);
    }
  }, {
    key: "startAnimation",
...
var ParticleOptions = /*#__PURE__*/_createClass(function ParticleOptions() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      variantRadius = _ref$variantRadius === void 0 ? 10 : _ref$variantRadius,
...
var Particle = /*#__PURE__*/function () {
  function Particle(canvas, particleOptions) {
  ...
  _createClass(Particle, [{
    key: "initPosition",
    value: function initPosition(canvas) {
...
var LineHubOptions = /*#__PURE__*/function () {
  ...
  _createClass(LineHubOptions, [{
    key: "initLineRadius",
    value: function initLineRadius(lineRadius) {
      this.lineRadius = lineRadius;
    }
  }, {
    key: "initRGB",
    value: function initRGB(color) {
...
var LineHub = /*#__PURE__*/function () {
  function LineHub(options, particles) {
  ...
  _createClass(LineHub, [{
    key: "initOptions",
    value: function initOptions(_ref) {
      var lineRadius = _ref.lineRadius,
          rgb = _ref.rgb;
      this.lineRadius = lineRadius;
      this.rgb = rgb;
    }
    ...
    key: "initParticles",
    value: function initParticles(particles) {
    ...
    value: function draw(ctx) {
      ...
      this.particles.forEach(function (sour) {
        return _this.lineToOthers(ctx, sour);
      });
    }
  }, {
    key: "lineToOthers",
    value: function lineToOthers(ctx, sour) {
      var _this2 = this;

      this.particles.forEach(function (dest) {
        return _this2.lineToDest(ctx, sour, dest);
      });
    }
  }, {
    key: "lineToDest",
    value: function lineToDest(ctx, sour, dest) {
      var distance = sour.calcDistance(dest);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_postcss_loader_dist_cjs_js_node_modules_sass_loader_dist_cjs_js_app_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13);
...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ParticleNetworkCanvas__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _app_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }
...
var App = /*#__PURE__*/_createClass(function App(selector) {
  _classCallCheck(this, App);

  this.particleNetworkCanvas = new _ParticleNetworkCanvas__WEBPACK_IMPORTED_MODULE_0__["default"](selector);
});

window.addEventListener("DOMContentLoaded", function () {
  return new App("#particleNetworkCanvas");
});
})();
